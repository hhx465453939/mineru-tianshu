...
export default {
  ...
  task: {
    ...
    confirmPause: 'Are you sure you want to pause this task? It will be temporarily removed from the queue.',
    confirmResume: 'Are you sure you want to resume this task? It will re-enter the queue.',
    confirmRetry: 'Are you sure you want to retry this task? Any prior progress will be reset.',
    confirmClearCache: 'Are you sure you want to clear the cache files? This frees disk space but keeps the database record.',
    confirmClearFailed: 'Are you sure you want to clear all failed tasks? This cannot be undone.',

    filesCleared: 'Files cleared',
    filesClearedDesc: 'To save server space, the result files have been cleared. The database record remains for reference.',
    ...
    clearFilters: '清除筛选条件',
    confirmBatchCancel: 'Are you sure you want to cancel {count} task(s)?',
